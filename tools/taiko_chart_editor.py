...
Uses same chart format as taiko_pygame.py (see ESLAB_FINAL_chart.py).

  pip install -r requirements_taiko.txt
  python taiko_chart_editor.py
  python taiko_chart_editor.py --charts-dir D:\\Music\\ESLAB_FINAL_charts
...
from ESLAB_FINAL_chart import FORMAT_VERSION
from ESLAB_FINAL_chart import load_chart_json
from ESLAB_FINAL_chart import resolve_audio_path
from ESLAB_FINAL_chart import save_chart_json
...
def main() -> None:
    ...
    pygame.display.set_caption("ESLAB FINAL Chart Editor")
