...
from ESLAB_FINAL_chart import ChartParseError
from ESLAB_FINAL_chart import load_chart_json
from ESLAB_FINAL_chart import resolve_audio_path
from ESLAB_FINAL_chart import song_length_from_notes
...
def main() -> None:
    ...
    pygame.display.set_caption("ESLAB FINAL Taiko — a0/a1 + Space/X + C (both)")
